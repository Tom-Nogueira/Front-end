...
:man_technologist:**Lucas Vilaboim**



HTMl criado 1991 --> Tim Berners-Lee

**Exemplo de Elemento de HTML**

![image-20220604135955307](C:\Users\wln_t\AppData\Roaming\Typora\typora-user-images\image-20220604135955307.png)

### Sua estrutura básica

<!DOCTYPE> <!-- <!DOCTYPE> diz ao navegador o que estamos escrevendo.-->
    <html> <!--<html> todo nosso documento estará aqui dentro, sendo do tipo HTML-->
        <head> <!-- <head> O Cabeçalho da página, é a meta informação, o navegador e buscador de internet precição.-->
            <meta> <!--  <meta> se usa muitas tags, por exemplo essa diz ao navegador como vai fazer incoder dos caracteres.-->
            <title>Estrutura Básica de escrita do HTML</title> <!--   <title> título do da página  -->       
        </head>
        <body> <!-- <body> Onde fica todo o conteúdo da página.-->
        </body>
</!doctype>


### Exercício será criar uma página pessoal.
...
O target neste momento vai servir para nos ajudar a abrir nossos links em outra aba do navegador usando o valor _blank. <!--Esse _blanck falta em muitos site, como por exemplo na UNICESUMAR onde cada vez que se clica em um link temos que voltar para o portal e logar novamente, falta _blanck lá rsrs -->
